<div>
	...
	<script>
		function register() {
			...
			//alert(formData);
			var url = "http://localhost:8080/waterplant_webappapi/LoginServlet?"
					+ formData;
			console.log(url);
			//alert(url);
			var formData = {};
